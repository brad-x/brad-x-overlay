...
# $Id: 3a493e22fc37db4c70491b81be26c30c7adaab26 $
...
quota selinux syslog system-heimdal systemd test winbind zeroconf"
...
multilib_src_configure() {
	...
	if ! use system-heimdal ; then
		bundled_libs="heimdal,heimbase,heimntlm,hdb,kdc,krb5,wind,gssapi,hcrypto,hx509,roken,asn1,com_err,NONE"
	fi
